  ...
  if (response.error) {
    return (
      <div className="Modal">
        ...
        Tämä on odottamaton virhe, jota ei pitäisi tapahtua. Syy virheelle voi olla:
        <ul>
          <li>
            Syötit paljon tiedostoja ja muisti loppui kesken. Palvelulla on 1GB muistia käytössä,
            tätä suurempi määrä tiedostoja ei toimi samassa suorituksessa.
          </li>
          <li>
            Suoritus aikakatkaistiin. Suuri määrä tiedostoja voi aiheuttaa aikakatkaisun, sillä
            palvelulla on 30 sekuntia suoritusaikaa. Tiedostojen lähettämiseen kulunut aika ei
            vaikuta tähän, ja siten vika ei ole verkkonopeudessasi.
          </li>
        </ul>
